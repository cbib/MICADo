...
# Example for the FLT3 transcript: python SNPfile_makor.py NM_004119.2.fasta refseq_22221.txt snp_FLT3.tab 200
...
for record in SeqIO.parse(FASTA, "fasta", generic_dna):
	...
	for i in range(1,len(lines)):
		...
		print "Write info for SNP %s"%(line_split[0])
